# This is the main source code file for ADC Archiver 1.4.2.
...
# ADC 1.4.2 is considered stable and production ready.

# ADC 1.4.2 is LTS (Long Term Support) and will receive updates for a long time.
...
def main():
    ...
    | ADC Archiver | Version: 1.4.2 "Grand Canyon" LTS |
