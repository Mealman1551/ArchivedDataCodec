# This is the main source code file for ADC Archiver 1.4.3.
...
# ADC 1.4.3 is considered stable and production ready.

# ADC 1.4.3 is LTS (Long Term Support) and will receive updates for a long time.
...
def fetch_update_json(url, timeout=5):
...
def check_and_show_update(url, local_version="1.4.3"):
    try:
...
def main():
    ...
    check_and_show_update(UPDATE_JSON_URL, "1.4.3")
    # .#
    ...
    | ADC Archiver | Version: 1.4.3 "Grand Canyon" LTS |
