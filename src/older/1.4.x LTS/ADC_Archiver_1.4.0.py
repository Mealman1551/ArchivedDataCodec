# This is the main source code file for ADC Archiver 1.4.0.
...
# ADC 1.4.0 is considered stable and production ready.

# ADC 1.4.0 is LTS (Long Term Support) and will receive updates for a long time.
...
def main():
    ...
    while True:
        command = input(f"Welcome to the ADC Archiver! Enter command ('c' to create, 'e' to extract, 'i' for info, 'q' to quit): ").strip().lower()
    ...
    | ADC Archiver | Version: 1.4.0 "Grand Canyon" LTS |
