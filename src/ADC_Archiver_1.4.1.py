...
# ADC 1.4.1 is considered stable and production ready.

# ADC 1.4.1 is LTS (Long Term Support) and will receive updates for a long time.
...
def main():
    ...
    | ADC Archiver | Version: 1.4.1 "Grand Canyon" LTS |
