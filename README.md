...
3. Download a C compiler, however not open source, i would recommend [Visual Studio Build Tools](https://visualstudio.microsoft.com/downloads/?q=build+tools#build-tools-for-visual-studio-2026). Make absolutely sure CLang is installed!
